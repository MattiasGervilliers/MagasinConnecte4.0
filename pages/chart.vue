  ...
  data() {
    ...
    return {
      data: {
        ...
        labels: exampleEnergy.values.map((v) => v.date),
        datasets: [
          {
            label: `Production de l'énergie par ${this.getStringByTimeUnit(exampleEnergy.timeUnit)} (${exampleEnergy.unit})`,
            backgroundColor: "#000000",
            borderColor: tailwindConfig.theme.extend.colors._primary[700],
            data: exampleEnergy.values.map((v) => v.value ?? 0),
          },
        ],
      },
      options: {
