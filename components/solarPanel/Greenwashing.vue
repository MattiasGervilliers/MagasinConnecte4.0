...
<template>
  <div class="greenwashing">
    <h2 class="font-extrabold text-4xl text-center">Bénéfices environmental</h2>
    <section class="emissions mt-28">
      <h3 class="font-bold text-2xl text-center">Réduction des émissions de CO<sub>2</sub></h3>
      <div class="emissions-data mt-10">
        <div class="single-data">
          <h4 class="font-bold text-xl">{{}} CO<sub>2</sub></h4>
        </div>

        <div class="single-data">
          <h4 class="font-bold text-xl">{{}} SO<sub>2</sub></h4>
        </div>

        <div class="single-data">
          <h4 class="font-bold text-xl">{{}} NOX</h4>
        </div>
      </div>
    </section>
